    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="About">
          <a class="nav-link"  href="<?php echo base_url()?>index.php/Admin/GoAbout">
            <i class="fa fa-fw fa-file"></i>
            <span class="nav-link-text">About</span>
          </a>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Shoping">
          <a class="nav-link" href="<?php echo base_url()?>index.php/Admin/GoShopping">
            <i class="fa fa-fw fa-dashboard"></i>
            <span class="nav-link-text">Shoping</span>
          </a>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Gallery">
          <a class="nav-link" href="<?php echo base_url()?>index.php/Admin/GoGallery">
            <i class="fa fa-fw fa-table"></i>
            <span class="nav-link-text">Gallery</span>
          </a>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Contact">
          <a class="nav-link" href="<?php echo base_url()?>index.php/Admin/GoContact">
